...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image15": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616dcfbb9e09be616e71d818_menu-main-dishes-restaurante-x-template%20(1).svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Product_Image_2": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616dc9ba43f4163d5f7b436e_chocolate-milkshake-restaurante-x-template-p-500%20(1).jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Product_Image_3": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616dc9aac480169bcc819e69_classic-fries-restaurante-x-template-p-500%20(1).jpeg"
      },
      "callbacks": {
        "onClick": [
          {
